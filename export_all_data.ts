...
async function exportAllData() {
  let connection;
  try {
    console.log("🔄 Conectando ao TiDB Cloud via DATABASE_URL...\n");

    // Usar DATABASE_URL que já tem a senha
    ...
    const exportPath = path.join(__dirname, "tidb-exported-all-data.json");
