...
// URL do escudo oficial do Marcílio Dias no CloudFront
const MARCILIO_DIAS_SHIELD_URL = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663350073320/bcRgjSMMkCohqWng.png";
      ...
      <View className="bg-gradient-to-b from-primary/10 to-background px-4 pt-4 pb-3">
        <View className="flex-row justify-between items-center mb-4">
          <View className="flex-row items-center gap-3 flex-1">
            <Image
              source={{ uri: MARCILIO_DIAS_SHIELD_URL }}
